...
import gift from '@/../public/assets/reward_icon.png';
...
const SendGiftModal: React.FC<Props> = (props) => {
  ...
  const randomTexts = ["注册即送100积分💰奖励，AI Visualization 智能分析平台为您提供稳定、安全、高效的服务！",
    "免费领取100积分💰奖励，通过链接注册，AI Visualization 智能分析平台为为您提供稳定、安全、高效的服务！",
    "通过链接注册，即可获得100积分💰奖励，AI Visualization 智能分析平台为为您提供稳定、安全、高效的服务！"];
