...
import { DatabaseOutlined, LoadingOutlined, PlusOutlined, SearchOutlined } from '@ant-design/icons';
import {
...
const AiAskData: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const wsPath =
      REACT_APP_ENV === 'dev'
        ? 'ws://localhost:8081/api/websocket/sql/'
        : 'ws://101.126.147.234:8081/api/websocket/sql/';
