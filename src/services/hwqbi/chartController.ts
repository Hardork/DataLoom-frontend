...
/** genChartByAiWithDataAsyncMq POST /api/chart/gen/async/mq/data */
export async function genChartByAiWithDataAsyncMqUsingPost(
  body: API.GenChartByAiWithDataRequest,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseBiResponse_>('/api/chart/gen/async/mq/data', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** genChartByAiAsyncMqV3 POST /api/chart/gen/async/mq/v3 */
export async function genChartByAiAsyncMqV3UsingPost(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.genChartByAiAsyncMqV3UsingPOSTParams,
  body: {},
  file?: File,
  options?: { [key: string]: any },
) {
  ...
  return request<API.BaseResponseBiResponse_>('/api/chart/gen/async/mq/v3', {
    method: 'POST',
    params: {
      ...params,
    },
